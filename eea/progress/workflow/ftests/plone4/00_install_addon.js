...
casper.test.begin('Add-on Install', function(test) {
   ...
   /* submit form */
   casper.waitForSelector("form input[value='eea.progress.workflow:default']",
       function success() {
           test.assertExists("form input[value='eea.progress.workflow:default']", "eea.progress.workflow check box is present");
           this.click("form input[value='eea.progress.workflow:default']");
       },
       function fail() {
           test.assertExists("form input[value='eea.progress.workflow:default']", "eea.progress.workflow check box is present");
   });
